        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HouseNumberName = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderFoodDatas", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OrderFoodDatas_Foods_FoodId",
                        column: x => x.FoodId,
                        principalTable: "Foods",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrderFoodDatas_Orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CurrentDeliveryId = table.Column<int>(type: "int", nullable: false),
                    FirstName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PhoneNumber = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DeliveryMens_Deliveries_CurrentDeliveryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeliveryMens_CurrentDeliveryId",
                table: "DeliveryMens",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderFoodDatas_FoodId",
                table: "OrderFoodDatas",
                column: "FoodId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderFoodDatas_OrderId",
                table: "OrderFoodDatas",
                column: "OrderId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Deliveries_DeliveryMens_DeliveryManId",
                table: "Deliveries",
                column: "DeliveryManId",
